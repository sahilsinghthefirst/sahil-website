...
export const ABOUT_SECTIONS = [
  ...
  },
  {
    ...
    paragraphs: [
      "I’m passionate about innovation, creation, and discovering new ways to solve problems. A fun fact about me is that I have a natural tendency to find unconventional ways around things, even if that tendency occasionally gets me into trouble.",
      ...
      "I am researching and learning about ML, and have done multiple projects in the past. My work has mostly focused on physics-informed neural nets, inverse problems, and natural language processing.",
    ],
  },
  {
    id: "bpc-fno-rit",
    ...
    paragraphs: [
      ...
      "Data was partly synthetic and real. Synthetic data was generated via the Bueno-Orovio-Cherry-Fenton cardiac model on OpenCARP (a cardiac data simulation tool). The real data was from a public data set, the Kiel Cardio Database. The current benchmark is synthetic; the Kiel Cardio Database was used as a reference for realistic MCG signal scale and sensor geometry.",
      ...
      "I recently began an internship in Professor Linwei Wang’s lab at Rochester Institute of Technology. I am studying ventricular tachycardia over there, specifically how to make an accurate synthetic pipeline via OpenCARP for VT data generation. I am working under Sumeet Atul Vadhavkar, a PhD student in the lab.",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "We are simulating our satellite’s power dynamics via FreeFlyer, a satellite software for power. We recently acquired our PCBs and the panels, and have started physical experimentation and devising testing.",
    ],
  },
  {
    ...
    paragraphs: [
      ...
      "For competitive programming, I am doing LeetCode and preparing to do USACO. Additionally, I am a part of FTC Team Geneton #26507, and we are a strong, determined team. I’m working in both building and programming.",
    ],
  },
  {
    id: "hackathons",
...
export const ABOUT_COPY_SHA256 = "81a4e4de46f91548739ff230155a30e0b07e62c3e9f4e3f053154906e4dc8f41";
